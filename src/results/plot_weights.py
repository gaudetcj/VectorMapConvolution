...
from src.models import resnet_vectormap
...
net = resnet_vectormap.ResNet18().to(device)
net.load_state_dict(torch.load('D:/Projects/VectorMapConvolution1/src/checkpoint/ckpt.t7')['net'])
...
plt.xlabel('L weight value', fontsize=14)
