...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10):
        ...
        self.conv1 = QuaternionConv(4, 112, kernel_size=3, stride=1, padding=1, bias=False)
        self.bn1 = nn.BatchNorm2d(112)
        self.layer1 = self._make_layer(block, 112, num_blocks[0], stride=1)
        self.layer2 = self._make_layer(block, 224, num_blocks[1], stride=2)
        self.layer3 = self._make_layer(block, 448, num_blocks[2], stride=2)
        self.layer4 = self._make_layer(block, 896, num_blocks[3], stride=2)
