...
from models.quaternionconv.quaternion_layers import QuaternionTransposeConv, QuaternionConv
from models.vectormapconv.vectormap_layers import VectorMapConv, VectorMapTransposeConv
...
class VCAE(nn.Module):
    ...
    def __init__(self):
        ...
        # ENCODER
        self.e1 = VectorMapConv(4, 4, 32, kernel_size=3, stride=2, padding=1)
        self.e2 = VectorMapConv(4, 32, 40, kernel_size=3, stride=2, padding=1)

        # DECODER
        self.d5 = VectorMapTransposeConv(4, 40, 32, kernel_size=3, stride=2, padding=1, output_padding=1)
        self.d6 = VectorMapTransposeConv(4, 32, 4, kernel_size=3, stride=2, padding=1, output_padding=1)
